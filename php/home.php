...
<section class="container-fluid mt-5">
    <div class="row">
            ...
            <div class="displayDrinks p-3">
                <div class="row">
                    <div class="col-md-12">
                       ...
                       <span class="numsOfDrinks p-2">4</span>
                       <span><i class="fas fa-plus"></i></span>
                       <span><i class="fas fa-minus"></i></span>
                       <span class="priceOfDrinks p-2">50</span>
        ...
        <!-------------------------->
         <!------for display to user------->
         <div class="col-md-7">
        <h2 class="pb-2" >your Favourite Drinks </h2>
             <div class="favDrinks">
                 <div class="row">
                     <div class="col-md-4">
                         <div class="card" >
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text"> Lorem ipsum dolor sit amet consectetur<span class="badge badge-danger">30l.E</span></p>
                            </div>
                     ...
                     <div class="col-md-4">
                         <div class="card">
                            ...
                            <div class="card-body">
                                <h5 class="card-title">Card title</h5>
                                <p class="card-text"> Lorem ipsum dolor sit amet consectetur.<span class="badge badge-danger">25L.E</span></p>
                            </div>
